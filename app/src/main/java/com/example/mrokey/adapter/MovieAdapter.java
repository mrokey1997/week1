...
//
//        @BindView(R.id.img_backdrop_land)   ImageView img_backdrop_land;
//        @BindView(R.id.tv_title_land)       TextView tv_title_land;
//        @BindView(R.id.tv_overview_land)    TextView tv_overview_land;
